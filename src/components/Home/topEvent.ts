...
export const topNews = [
    ...
    {
        image: 'https://images.prismic.io/impactio-blog/4adb30b7-17db-4213-9696-c9b3b030d813_miguel-henriques-E0bIdzi8zoQ-unsplash.jpg?auto=compress,format',
        title: 'New Technology Research Seminar',
        description: 'Attend seminars to stay updated with the latest technology trends.',
    },
...
export const testimonials = [
    ...
    },
    {
        name: 'Trần Thị B',
        position: 'Giảng Viên',
        feedback: 'Hỗ trợ rất tốt trong việc thực hiện các dự án nghiên cứu của tôi.',
        avatar: '/images/avatar2.jpg',
    },
    {
        name: 'Lê Văn C',
        position: 'Nhân Viên Phòng Lab',
        feedback: 'Quản lý thiết bị và hỗ trợ kỹ thuật luôn tận tâm và chuyên nghiệp.',
